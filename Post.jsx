...
export default function Post({ userProfile, username, caption, postId , photoUrl, noLikes, postUserId }) {
  ...
  useEffect(() => {
    ...
    const deletePost = () =>{
      // getting reffernce of image frome  storage and deleting 
      if(photoUrl){
  ...
  return (
    ...
    <div className="post">
            ...
            <img src={photoUrl} className="post__image" />
            ...
            {
                user? <PostOptions postId={postId} /> : <></>   
            }
...

            {
                comments.map((comment) => (
                    <div className={`comments__show ${comment.uid == postUser?.uid && 'myself'}`}>
                        <Avatar
